...
class LoginPage(BasePage):
    ...
    def verificar_texto_mensagem_erro_login(self, texto_experado):
        texto_encontrado = self.pegar_texto_elemento(self.error_message_login)
        assert texto_encontrado == texto_experado, f"O texto encontrado foi '{texto_encontrado}', mas era esperado o texto '{texto_experado}'."
